...
class BookingController extends Controller
{
    ...
    public function booking(){
        ...
        return view('agent.booking',compact('staff'));
    }
    public function bookingdetails($id){
        ...
        return view('agent.booking_details',compact('booking_service','booking','customer','shop','vehicle','colour','pickup_driver','delivery_driver'));
    }
