    ...
    <div class="modal__content">
        ...
        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
            <div class="col-span-12 sm:col-span-12">
                ...
                <select class="input w-full border mt-2 flex-1" name="category" id="category">
            ...
            <div class="col-span-12 sm:col-span-12">
                <label>Service</label>
                <input autocomplete="off" type="text" class="input w-full border mt-2 flex-1" name="service" id="service">
            </div>
        </div>
        </form>
...
function Edit(id){
  $.ajax({
    url : '/agent/edit-new-service/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      $('#modal-title').text('Update New Service');
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/agent/delete-new-service/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
