                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-base text-gray-600 mt-1">Bookings</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">AED {{$booking_value}}</div>
                                <div class="text-base text-gray-600 mt-1">Booking Value</div>
                            </div>
                        </div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                    ...
                    <div class="col-span-12 sm:col-span-6 xl:col-span-3 intro-y">
                        <div class="report-box zoom-in">
                            <div class="box p-5">
                                ...
                                <div class="text-3xl font-bold leading-8 mt-6">{{$reviews}}</div>
                                <div class="text-base text-gray-600 mt-1">Reviews</div>
                            </div>
                        </div>
                    </div>
                </div>
...
$('.dashboard').addClass('top-menu--active');
</script>
@endsection
