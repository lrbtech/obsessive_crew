...
<div class="content">
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button id="add_new" class="button text-white bg-theme-1 shadow-md mr-2">Add New Package</button>
                    ...
                    <td class="w-40">
                        <div class="flex">
                            <div class="w-10 h-10 image-fit zoom-in">
                                <img class="tooltip" src="/upload_service/{{$row->image}}" title="{{$row->package_name_english}}">
                            </div>
                        </div>
                    </td>
                    <td>{{$row->price}}</td>
    ...
    <div class="modal__content">
        ...
        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
            <div class="col-span-12 sm:col-span-12">
                ...
                <select class="select2 w-full" multiple name="service_ids[]" id="service_ids">
            ...
            <div class="col-span-12 sm:col-span-12">
                ...
                <input autocomplete="off" type="text" class="input w-full border mt-2 flex-1" name="package_name_english" id="package_name_english">
            </div>
            <div class="col-span-12 sm:col-span-12">
                <label>Package Name Arabic</label>
                <input autocomplete="off" type="text" class="input w-full border mt-2 flex-1" name="package_name_arabic" id="package_name_arabic">
            </div>
            <div class="col-span-12 sm:col-span-12">
                <label>Price</label>
...
//$('.package').addClass('top-menu--active');
...
{
    $.ajax({        
        url : '/agent/get-shop-package-services/'+id,
        type: "GET",
        success: function(data)
        {
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/agent/delete-package/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
