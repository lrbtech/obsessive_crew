                ...
                <table style="background-color: #f2f3f8; max-width:670px; margin:0 auto;" width="100%" border="0"
                    ...
                    ?>
                        <td style="text-align:center;">
                            <a href="http://autotech.ae" title="logo" target="_blank">
                            <img width="60" src="{{$url}}images/logo_icon.png" title="logo" alt="logo">
                          </a>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0 35px;">
                                        ...
                                        <p style="font-size:15px; color:#455056; margin:8px 0 0; line-height:24px;">
                                            Your account has been created on the Autotech by Wash. Below are your system generated credentials, <br><strong>Please change
                                        ...
                                        <p
                                            ...
                                            <strong
                                                style="display: block;font-size: 13px; margin: 0 0 4px; color:rgba(0,0,0,.64); font-weight:normal;">Username</strong>{{$customer->mobile}}
                                            <!-- <strong
                    ...
                    <tr>
                        <td style="text-align:center;">
                            <p style="font-size:14px; color:rgba(69, 80, 86, 0.7411764705882353); line-height:18px; margin:0 0 0;">&copy; <strong>www.autotech.ae</strong> </p>
                        </td>
                    </tr>
                    <tr>
                        <td style="height:80px;">&nbsp;</td>
