            ...
            <table id="datatable" class="table table-report -mt-2">
                <thead>
                    <tr>
                        ...
                        <th class="whitespace-no-wrap">Service</th>
...
$('.new-service').addClass('side-menu--active');
...
function UpdateStatus(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/update-new-service-status/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            Swal.fire({
                ...
                var new_url = '/admin/get-new-service';
                orderPageTable.ajax.url(new_url).load(null, false);
            });
        }
      });
