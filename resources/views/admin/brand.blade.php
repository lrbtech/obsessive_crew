...
<div class="content">
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button id="add_new" class="button text-white bg-theme-1 shadow-md mr-2">Add New Brand</button>
        </div>
    </div>
    <!-- BEGIN: Datatable -->
        ...
        <table class="table table-report table-report--bordered display datatable w-full">
            <thead>
                <tr>
                    ...
                    <th class="border-b-2 whitespace-no-wrap">Brand Name</th>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="/admin/vehicle-model/{{$row->id}}">{{$row->brand_name}}</a></td>
                    <td class="w-40">
                        <div class="flex">
    ...
    <div class="modal__content">
        ...
        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
            <div class="col-span-12 sm:col-span-12">
                ...
                <input autocomplete="off" type="text" class="input w-full border mt-2 flex-1" name="brand_name" id="brand_name">
            </div>
            <div class="col-span-12 sm:col-span-12">
                <label>Image</label>
