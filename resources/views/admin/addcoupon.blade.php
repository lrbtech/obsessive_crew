        ...
        <div class="intro-y col-span-12 lg:col-span-12">
            ...
            <div class="intro-y box p-5">
                <div>
                    ...
                    <input autocomplete="off" type="text" class="input w-full border mt-2" placeholder="Enter your coupon code" name="coupon_code" id="coupon_code">
                </div>
                <div class="mt-3">
                ...
                <div class="mt-3">
                    <div class="sm:grid grid-cols-2 gap-6">
                        <div class="relative mt-2">
                          ...
                          <input autocomplete="off" type="date" class="input w-full border mt-2" name="start_date" id="start_date">
                        </div>
                        <div class="relative mt-2">
                          <label>End Date</label>
                          <input autocomplete="off" type="date" class="input w-full border mt-2" name="end_date" id="end_date">
                        </div>
                    </div>
                </div>
                <div class="mt-3">
                    <div class="sm:grid grid-cols-2 gap-6">
                        ...
                        <div class="relative mt-2">
                          ...
                          <input autocomplete="off" type="number" id="amount" name="amount" class="input w-full border mt-2" placeholder="Enter the discount Amount">
                        </div>
                    </div>
                </div>
                <div class="mt-3">
                    <div class="sm:grid grid-cols-2 gap-6">
                        <div class="relative mt-2">
                          ...
                          <input autocomplete="off" type="text" class="input w-full border mt-2" name="minimum_order_value" id="minimum_order_value">
                        </div>
                        <div class="relative mt-2">
                          <label>Usage limit per user</label>
                          <input autocomplete="off" type="text" class="input w-full border mt-2" name="limit_per_user" id="limit_per_user">
                        </div>
                    </div>
                </div>
                <div class="mt-3">
