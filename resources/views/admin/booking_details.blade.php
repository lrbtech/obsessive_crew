    ...
    <div id="printarea" class="intro-y box overflow-hidden mt-5">
        <div class="flex flex-col lg:flex-row pt-10 px-5 sm:px-20 sm:pt-20 lg:pb-20 text-center sm:text-left">
            ...
            <div class="mt-20 lg:mt-0 lg:ml-auto lg:text-right">
                <div class="text-xl text-theme-1 font-medium">Obsessive Crew</div>
                <div class="mt-1">info@lrbtech.com</div>
                <div class="mt-1">+971 123456789</div>
                <div class="mt-1">Abu Dhabi,UAE</div>
            </div>
        </div>
