...
<div class="content">
    ...
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <button id="add_new" class="button text-white bg-theme-1 shadow-md mr-2">Add New Colour</button>
        </div>
    </div>
    <!-- BEGIN: Datatable -->
        ...
        <table class="table table-report table-report--bordered display datatable w-full">
            <thead>
                <tr>
                    ...
                    <th class="border-b-2 whitespace-no-wrap">Colour Name</th>
    ...
    <div class="modal__content">
        ...
        <div class="p-5 grid grid-cols-12 gap-4 row-gap-3">
            ...
            <div class="col-span-12 sm:col-span-12">
                ...
                <input autocomplete="off" type="text" class="input w-full border mt-2 flex-1" name="code" id="code">
            </div>
        </div>
        </form>
...
$('.colour').addClass('side-menu--active');
...
function Edit(id){
  $.ajax({
    url : '/admin/edit-colour/'+id,
    type: "GET",
    dataType: "JSON",
    success: function(data)
    {
      $('#modal-title').text('Update Colour');
...
function Delete(id,status){
    ...
    if (r == true) {
      $.ajax({
        url : '/admin/delete-colour/'+id+'/'+status,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
